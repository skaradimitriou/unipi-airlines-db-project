    ...
    <body>
        ...
        <div id ="categories" class="container">
            ...
            $sql = "SELECT airports.city, airports.code, airports.name, COUNT(*) as visitors
                    ...
                    WHERE departure_date BETWEEN '".$_POST["flight_year"]."-1-1' AND '".$_POST["flight_year"]."-12-31'
            ...
            if($countResults > 0 ){  
                //php string with placeholders
                $format = '<p class="container_title">Δημοφιλείς Προορισμοί για το %s </p>';
